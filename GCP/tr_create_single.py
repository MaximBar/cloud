...
print("Syntax is: python tr_create_single.py suffix image zone machine-size subnetwork 'do not stop(yes/no)' 'do not delete(yes/no)'")
print("Example: python tr_create_single.py maxim.bar-my-test1 thetaray-image-ubuntu-17-3-0-java us-east1-b n1-standard-2 rnd-subnet yes no")
...
instance_name = "tr-single-" + str(suffix)
