...
print("Syntax is: python tr_create_cluster.py image zone machine-size subnetwork 'do not stop(yes/no)' 'do not delete(yes/no)' cluster deploy-type node-number(1-9)")
print("Example: python tr_create_cluster.py grc-new2 us-east1-b n1-standard-2 rnd-subnet yes no cluster min 1")
