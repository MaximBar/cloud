...
instance_name = "dev-thetaray-" + str(image) + "-" + str(account)
...
subprocess.check_call(['gcloud', 'compute', 'instances', 'create', instance_name, '--image', image, '--machine-type', machine, '--subnet', subnetwork])
...
subprocess.check_call(['gcloud', 'compute', 'instances', 'add-tags', instance_name, '--tags', tag])
